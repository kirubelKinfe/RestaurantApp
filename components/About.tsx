...
const About = () => {
    return (
        <section className="bg-white grid w-full px-5 sm:px-10 lg:px-20 grid-cols-1 sm:grid-cols-2 pt-16 sm:pt-28 justify-center items-center gap-12" id="about">
